...
//               <div className="relative bg-gradient-to-br from-primary to-navy-800 rounded-2xl p-3 text-white shadow-glow">
//                 <Car size={28} />
//               </div>
//             </motion.div>
//             <span className="font-bold text-3xl tracking-tight text-gradient">
//               My Drivemate
//             </span>
//           </Link>
...
//                         : 'text-foreground hover:bg-white/10 dark:hover:bg-white/5 hover:backdrop-blur-sm'
//                     }`}
//                   >
//                     {item.title}
//                   </Link>
...
//                 <Link
//                   to="/notifications"
//                   className="p-4 ml-2 rounded-xl text-foreground hover:bg-white/10 dark:hover:bg-white/5 transition-all duration-300 backdrop-blur-sm"
...
//                 className="ml-4 px-6 py-3 rounded-xl font-semibold text-base btn-primary"
//                 whileHover={{ scale: 1.05 }}
//                 whileTap={{ scale: 0.95 }}
//               >
//                 Sign Out
...
//             ) : (
//               <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
//                 <Link to="/login" className="ml-4 px-6 py-3 rounded-xl font-semibold text-base btn-primary">
//                   Sign In
//                 </Link>
//               </motion.div>
//             )}
...
//                 <Link
//                   to="/notifications"
//                   className="p-4 rounded-xl text-foreground hover:bg-white/10 dark:hover:bg-white/5 transition-all duration-300"
//                   aria-label="Notifications"
//                 >
//                   <Bell size={22} />
//                 </Link>
...
//       {isMobileMenuOpen && (
//         <motion.div 
//           className="lg:hidden water-glass shadow-water border-t border-white/20"
...
//               <motion.button
//                 onClick={handleSignOut}
//                 className="w-full text-left px-5 py-4 rounded-xl text-lg font-semibold text-foreground hover:bg-white/10 dark:hover:bg-white/5 transition-all duration-300"
//                 initial={{ x: -20, opacity: 0 }}
//                 animate={{ x: 0, opacity: 1 }}
...
//                 <Link
//                   to="/login"
//                   className="block px-5 py-4 rounded-xl text-lg font-semibold text-foreground hover:bg-white/10 dark:hover:bg-white/5 transition-all duration-300"
//                 >
//                   Sign In
//                 </Link>
//               </motion.div>
